export const WEEKDAY_HABITS = [
  ...
  { id: "work_start", name: "💻 Work Start at Desk", time: "11:00", applies: "all" },
  { id: "nap_15m", name: "⏱️ 15-min Power Nap (alarm set first)", time: "12:50", applies: "all" },
  { id: "insta_capped", name: "📵 Instagram ≤ 15 min (timer on)", time: "13:05", applies: "all" },
  { id: "standup_prep", name: "📞 Standup Prep (20 min)", time: "17:00", applies: "all" },
  { id: "standup_call", name: "🗣️ Standup Call (5:20 PM)", time: "17:20", applies: "all" },
  { id: "eod_note", name: "📝 EOD Summary Note (3 done, 1 pending)", time: "19:45", applies: "all" },
  { id: "log_off", name: "🛑 Log Off Work", time: "20:00", applies: "all" },
  { id: "evening_walk", name: "🌙 Evening Walk in Garden (30-45 min)", time: "21:00", applies: "all" },
